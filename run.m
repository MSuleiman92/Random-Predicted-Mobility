...
sn_positioning = ["random","even_confined"]; % Mobile Sink Positioning Method to be compared
...
k = 4000; % Bits transmitted per packet
...
if ismember("prediction", pn_select_method)
    if generate_new_model
        ...
        data = data_gathering(n, sn, "random", dims, ener, n_clusters, rounds, mob_params, train_data);
